...
namespace LanLord
{
    public partial class main : Form
    {
        ...
        int panelBarraTituloColor = Color.FromArgb(1, 4, 9).ToArgb();
        int mainColor = Color.FromArgb(13, 17, 23).ToArgb();
        int secondaryColor = Color.FromArgb(22, 27, 34).ToArgb();
        int pressedColor = Color.FromArgb(29, 78, 216).ToArgb();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            SolidBrush solidBrush = new SolidBrush(Color.FromArgb(29, 78, 216));
        ...
        private void showSubMenu(Panel subMenu, Button button)
        {
            ...
            else
            {
                ...
                button.BackColor = Color.FromArgb(13, 17, 23);
            }
        }
